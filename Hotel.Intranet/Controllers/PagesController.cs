...
namespace Hotel.Intranet.Controllers
{
    public class PagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdStrony,LinkTytul,Tytul,Tresc,Pozycja")] Page page)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdStrony,LinkTytul,Tytul,Tresc,Pozycja")] Page page)
        {
            if (id != page.IdStrony)
            {
                return NotFound();
